...
# installed.
TCL_PREFIX='/Scr/scr-test-steven/install/tcl/8.6.4'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Scr/scr-test-steven/install/tcl/8.6.4'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Scr/scr-test-steven/Programs/Tcl/build_tcl-8.6.4 -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Scr/scr-test-steven/install/tcl/8.6.4/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Scr/scr-test-steven/install/tcl/8.6.4/include'
...
# compiled.
TCL_SRC_DIR='/Scr/scr-test-steven/Programs/Tcl/tcl8.6.4'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/Scr/scr-test-steven/install/tcl/8.6.4/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Scr/scr-test-steven/Programs/Tcl/build_tcl-8.6.4 -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Scr/scr-test-steven/install/tcl/8.6.4/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Scr/scr-test-steven/Programs/Tcl/build_tcl-8.6.4/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Scr/scr-test-steven/install/tcl/8.6.4/lib/libtclstub8.6.a'
